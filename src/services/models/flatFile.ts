...
export interface FlatFileAttributes {
  ...
  license_key: JSON_Type,
  license_is_unknown: boolean,
  license_score: JSON_Type,
  license_short_name: JSON_Type,
  license_category: JSON_Type,
  license_owner: JSON_Type,
  license_homepage_url: JSON_Type,
  license_text_url: JSON_Type,
  license_reference_url: JSON_Type,
  license_spdx_key: JSON_Type,
  license_start_line: JSON_Type,
  license_end_line: JSON_Type,
  license_matched_rule: JSON_Type,
  email: JSON_Type,
  ...
  package_data_license_expression: JSON_Type,
...
interface FlattenedFile {
  ...
  license_key: unknown[],
  license_is_unknown: boolean,
  license_score: unknown[],
  license_short_name: unknown[],
  license_category: unknown[],
  license_owner: unknown[],
  license_homepage_url: unknown[],
  license_text_url: unknown[],
  license_reference_url: unknown[],
  license_spdx_key: unknown[],
  license_start_line: unknown[],
  license_end_line: unknown[],
  license_matched_rule: unknown[],
  email: unknown[],
  ...
  package_data_license_expression: unknown[],
...
export function flattenFile(file: any): any { 
  return {
    ...
    package_data_extracted_license_statement: getNestedValues(file.package_data, 'license_detections', 'extracted_license_statement'),
    package_data_license_expression: getNestedValues(file.package_data, 'license_detections', 'license_expression'),
